...
```
    ...
    Installing package into '/home/user72/R/x86_64-pc-linux-gnu-library/4.3'
...
### Другой злоумышленник установил запланированную задачу в системном планировщике cron для экспорта содержимого внутренней wiki системы. Эта система генерирует большое количество трафика в нерабочие часы, больше чем остальные хосты. Определите IP этой системы. Известно, что ее IP адрес отличается от нарушителя из предыдущей задачи.
...
Научился основам работы с СУБД Clickhouse для обработки и анализа больших данных при помощи языка программирования R
